    ...
    <div class="form-container">
        ...
        <form action="submit.php" method="POST">
            ...
            <fieldset>
                ...
                if (isset($_SESSION['name'])) { echo $_SESSION['name']; unset($_SESSION['name']);}
                ?>">
                ...
                <select id="gender" name="gender">
                    ...
                    <option value="male" <?php if(isset($_SESSION['gender'])){
                        if(($_SESSION['gender']) == 'male'){
                            echo 'selected';
                            unset ($_SESSION['gender']);
                        }
                    } ?>>Male</option>
                    <option value="female" <?php if(isset($_SESSION['gender'])){
                        if(($_SESSION['gender']) == 'female'){
                            echo 'selected';
                            unset ($_SESSION['gender']);
                        }
                    } ?>>Female</option>
                    <option value="other" <?php if(isset($_SESSION['gender'])){
            ...
            <fieldset>
                ...
                if (isset($_SESSION['phone'])) { echo $_SESSION['phone']; unset($_SESSION['phone']);}
                ?>">
                ...
                <textarea id="address" name="address" rows="4"><?php
            ...
            <fieldset class="confirmation">
                <input type="checkbox" value="done" class="confirmation-input" name="confirmation" <?php if(isset($_SESSION['confirmation'])){
                        if(($_SESSION['confirmation']) == 'done'){
                            echo 'checked';
